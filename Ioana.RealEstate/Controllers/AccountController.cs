...
namespace Ioana.RealEstate.Controllers
{
    ...
    public class AccountController : Controller
    {
        public AccountController()
            : this(new RealEstateUserManager(new RealEstateUserStore(new RealEstateDbContext())))
        {
        }

        public AccountController(RealEstateUserManager userManager)
        {
            this.UserManager = userManager;
        }

        public RealEstateUserManager UserManager { get; private set; }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new RealEstateUser() { UserName = model.UserName };
        ...
        private async Task SignInAsync(RealEstateUser user, bool isPersistent)
        {
